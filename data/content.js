...
export const META = {
  ...
  enrichedNote: "Enrichment pass completed 7 July 2026, addendum merged 9 July 2026. Every dated development was checked against current sources; entries give the source by name so the binder stays self-contained.",
};
  ...
  },
  {
    ...
    readings: [
      ...
      },
      {
        ...
        blurb: "WCKD cannot afford Azania to be a carbon story it has to explain away two months before publishing its first targets. Its green demands are structural, not decorative. Note: a 5th edition shipped Mar 2026 (see Recent developments) — check what changed before quoting mechanics.",
      },
      {
        id: "modC-5",
      ...
      {
        id: "modC-24",
        title: "NZAOA Target-Setting Protocol, 5th edition released Mar 2026 (supersedes the 4th ed. on this shelf)",
        depth: "REF",
        tag: "recent",
