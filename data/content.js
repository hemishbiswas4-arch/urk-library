...
// enriched with verified source URLs researched 2026-07-08 and 2026-07-09.
// Depth key: READ = full careful read, SKIM = intro/summary/headings, REF = know it exists, WATCH = video/talk.
// tag key: core = primary reading, further = supplementary, recent = a dated development (still a real book on the shelf).
//
// Reading order within each module's `readings` array is deliberate: it is the
// shelf's progressive order, foundational → advanced (re-sequenced 11 Jul 2026).
// The 3D scene renders each shelf's first third on the TOP board (left→right),
// the middle third on the MIDDLE board, and the last third on the BOTTOM board —
// so reordering this array is exactly how you re-sequence a shelf.
...
export const META = {
  ...
  enrichedNote: "Enrichment pass completed 7 July 2026, addendum merged 9 July 2026, shelves re-sequenced foundational→advanced 11 July 2026. Every dated development was checked against current sources; entries give the source by name so the binder stays self-contained.",
};
...
export const MODULES = [
  ...
  },
  {
    ...
    readings: [
      ...
      {
        id: "neg-12",
        title: "PON — “What Is Multiparty Negotiation?” (Susskind/Mnookin framework, updated Jun 2026)",
        depth: "READ",
        tag: "further",
        url: "https://www.pon.harvard.edu/daily/dealmaking-daily/managing-a-multiparty-negotiation/",
        blurb: "Coalition formation, shifting BATNAs, and blocking coalitions in exactly a 3-party format.",
      },
      {
        id: "neg-5",
      ...
      {
        id: "neg-13",
        title: "PON — “How Coalitions Benefit Negotiators at the Bargaining Table” (Mar 2026)",
        depth: "SKIM",
        tag: "further",
        url: "https://www.pon.harvard.edu/daily/negotiation-skills-daily/the-benefits-of-coalition-building/",
        blurb: "When URK should ally with WCKD vs Sirius1 issue-by-issue rather than treating them as one bloc.",
      },
      {
        id: "neg-4",
  ...
  },
  {
    ...
    readings: [
      ...
      {
        id: "modA-13",
        title: "CBRE — “Asia Pacific Data Centre Boom to Continue in 2026” (Feb 2026)",
        depth: "SKIM",
        tag: "further",
        url: "https://www.cbre.com/insights/articles/asia-pacific-data-centre-boom-to-continue-in-2026",
        blurb: "Market context: 100 MW+ sites are the prize class; URK is not a supplicant, it holds scarce inventory.",
      },
      {
        id: "modA-9",
      ...
      {
        id: "modA-10",
        title: "Global Data Center Hub — “The Renewable PPA Bottleneck in Asia's Tier 1 Data Centers” (Feb 2026)",
        depth: "READ",
        tag: "further",
        url: "https://www.globaldatacenterhub.com/p/the-renewable-ppa-bottleneck-in-asias",
        blurb: "“Time-to-power is a core underwriting variable” — the single best frame for why proposal (a) is leverage, not charity.",
      },
      {
        id: "modA-11",
        title: "BCLP — “Powering up data centre development in SE Asia with new direct PPA frameworks”",
        depth: "SKIM",
        tag: "further",
        url: "https://www.bclplaw.com/en-US/events-insights-news/powering-up-data-centre-development-in-se-asia-with-new-direct-ppa-frameworks.html",
        blurb: "Vietnam DPPA Decree 80/2024 and Malaysia CRESS — the regional menu of structures URK can offer under (a).",
      },
      {
        id: "modA-12",
        title: "KWM — Corporate PPAs in APAC series (Vietnam, Japan, Malaysia, Korea)",
        depth: "REF",
        tag: "further",
        url: "https://www.kwm.com/global/en/insights/latest-thinking/transforming-energy-landscapes-corporate-ppas-in-apac.html",
        blurb: "Jurisdiction-by-jurisdiction PPA mechanics if judges probe implementation detail.",
      },
      {
        id: "modA-7",
      ...
      {
        id: "modA-15",
        title: "IMDA — Tropical Data Centre Standard (SS 697:2023)",
        depth: "REF",
        tag: "further",
        url: "https://www.imda.gov.sg/how-we-can-help/green-dc-roadmap/tropical-dc-standard",
        blurb: "Concrete, named standard for cooling efficiency in a tropical climate — usable as a term-sheet condition.",
      },
      {
        id: "modA-16",
        title: "IMDA/BCA — Green Mark for Data Centres scheme",
        depth: "REF",
        tag: "further",
        url: "https://www.imda.gov.sg/how-we-can-help/bca-imda-green-mark-for-data-centres-scheme",
        blurb: "Certification URK can require Azania to obtain — a costless-sounding sustainability “win” to trade.",
      },
      {
        id: "modA-14",
        title: "Reed Smith — “Navigating Singapore's Data Centre Regulatory Framework” (Nov 2025)",
        depth: "SKIM",
        tag: "further",
        url: "https://www.reedsmith.com/articles/navigating-singapores-data-centre-regulatory-framework/",
        blurb: "One-stop map of GDCR, GMDC:2024, SS 697 tropical standard — the benchmark regime URK can demand Azania match.",
      },
      {
        id: "modA-18",
        ...
        blurb: "Proof a host state can auction access against green conditions — URK's strongest structural analogy.",
      },
      {
        id: "modA-17",
        ...
        blurb: "First move to a statutory licensing regime with binding energy/resource-efficiency standards. Judges may have this open on their desks.",
      },
      {
        id: "modA-20",
        title: "Singapore DIA detail: FDI licensing for cloud ≥S$100m revenue and DCs ≥10 MW (consultation to 22 Jul 2026)",
        depth: "REF",
        tag: "recent",
        url: "https://dig.watch/updates/singapore-proposes-digital-infrastructure-bill-to-strengthen-cloud-security",
        blurb: "The bill's licensing thresholds are a ready-made template for URK-side regulatory asks.",
      },
      {
        id: "modA-21",
        title: "DIA will impose mandatory PUE standards on ALL data centres, existing and future (Feb 2026)",
        depth: "REF",
        tag: "recent",
        url: "https://www.theedgesingapore.com/digitaledge/digital-economy/singapore-plans-legislation-impose-energy-cybersecurity-standards-data",
        blurb: "Shift from voluntary guidance to enforceable efficiency obligations — precedent for hard-coding PUE/WUE into the Azania deal.",
      },
      {
        id: "modA-22",
        title: "Eco-Business — DIA sustainability/resilience analysis; DCs near 20% of SG grid capacity in 2026",
        depth: "REF",
        tag: "recent",
        ...
        blurb: "Grid-share statistic that dramatises what 100 MW means for a developing-country grid.",
      },
      {
        id: "modA-19",
        ...
        blurb: "Water-cooled expansions deferred, approvals halted for Tier 1/2 facilities.",
      },
    ],
  },
  {
    ...
    readings: [
      {
        id: "modB-10",
        title: "WRI — “What Are NDCs?” explainer (Aug 2025)",
        depth: "SKIM",
        tag: "further",
        url: "https://www.wri.org/insights/nationally-determined-contributions-ndcs-explained",
        blurb: "Conditional vs unconditional NDCs — the exact legal-rhetorical structure behind URK's finance/tech-transfer framing.",
      },
      {
        id: "modB-1",
      ...
      {
        id: "modB-11",
        title: "WRI — “Despite Some Progress, Countries' New Climate Plans Largely Fall Short” (Nov 2025)",
        depth: "SKIM",
        tag: "further",
        url: "https://www.wri.org/insights/assessing-2025-ndcs",
        blurb: "Current NDC 3.0 gap numbers; conditional-pledge data URK can cite without sounding defensive.",
      },
      {
        id: "modB-15",
        ...
        blurb: "Aggregate ~12% cuts by 2035 vs 2019 — context for why an ambitious NDC like URK's is diplomatically valuable.",
      },
      {
        id: "modB-8",
        title: "UNFCCC — “What is technology development and transfer?” (Art 10, TEC + CTCN explained)",
        depth: "READ",
        tag: "further",
        url: "https://unfccc.int/topics/climate-technology/what-is-technology-development-and-transfer",
        blurb: "The official vocabulary for proposal (b): technology framework, Technology Mechanism, TNAs — speak it fluently.",
      },
      {
        id: "modB-6",
      ...
      {
        id: "modB-9",
        title: "Sharman — “Inter-State climate technology transfer under the UNFCCC: A benefit-sharing approach” (RECIEL 2022)",
        depth: "REF",
        tag: "further",
        url: "https://onlinelibrary.wiley.com/doi/10.1111/reel.12454",
        blurb: "Academic depth on Art 4(5) UNFCCC + Art 10 obligations if the Solicitor-General needs doctrine.",
      },
      {
        id: "modB-12",
        ...
        blurb: "Triple adaptation finance by 2035, Belém mission to 1.5°C, first COP text on unilateral trade measures.",
      },
      {
        id: "modB-13",
        ...
        blurb: "Rights-based framing — labour rights, social dialogue, FPIC. Borrow this vocabulary for proposals (b) and (c).",
      },
      {
        id: "modB-14",
        ...
        blurb: "10 partner countries as of Oct 2025, plus the Philippines (May 2026). Ready-made creative option for Azania.",
      },
      {
        id: "modB-16",
        ...
        blurb: "Launched at Belém with $6bn+ seeded — evidence blended sovereign-plus-private climate finance is the current direction of travel.",
      },
      {
        id: "modB-3",
  ...
  },
  {
    ...
    readings: [
      ...
      {
        id: "modC-16",
        title: "World Bank PPPLRC — Power Purchase Agreements (PPAs and EPAs)",
        depth: "SKIM",
        tag: "further",
        url: "https://ppp.worldbank.org/public-private-partnership/sector/energy/energy-power-agreements/power-purchase-agreements",
        blurb: "Sample PPAs and key clauses (change-in-law, force majeure, termination) — options-generation raw material.",
      },
      {
        id: "modC-15",
        title: "World Bank PPPLRC — Implementation Agreements for Power PPPs",
        depth: "READ",
        tag: "further",
        url: "https://ppp.worldbank.org/public-private-partnership/sector/energy/energy-power-agreements/implementation-agreements",
        blurb: "The standard government↔investor contract wrapping a new energy project — the actual instrument for structuring (a).",
      },
      {
        id: "modC-2",
      ...
      {
        id: "modC-20",
        title: "UN-Energy — 24/7 Carbon-Free Energy Compact",
        depth: "REF",
        tag: "further",
        url: "https://www.un.org/en/energy-compacts/page/compact-247-carbon-free-energy",
        blurb: "Hourly-matched clean power as the gold-standard ask (or aspirational trade) on Azania's energy sourcing.",
      },
      {
        id: "modC-10",
      ...
      {
        id: "modC-19",
        title: "One Planet Sovereign Wealth Funds — Framework",
        depth: "REF",
        tag: "further",
        url: "https://oneplanetswfs.org/",
        blurb: "WCKD's SWF investors likely operate under this — a second normative hook on the investor side beyond NZAOA.",
      },
      {
        id: "modC-5",
      ...
      },
      {
        ...
        tag: "recent",
        url: "https://www.acra.gov.sg/regulations/sustainability-reporting/requirements-timeline/",
        blurb: "Sirius1 is an STI constituent: Azania's emissions sit inside its mandatory Scope 3 from FY2026 — a precise persuasion weapon in front of Singapore lawyers.",
      },
      {
        id: "modC-25",
        title: "ACRA/SGX RegCo press release, 25 Aug 2025 — STI constituents keep full ISSB CRD from FY2025, Scope 3 from FY2026",
        depth: "REF",
        tag: "recent",
        url: "https://www.acra.gov.sg/news-events/news-announcements/887/",
        blurb: "Sirius1 (SS) is an STI constituent: its Scope 3 reporting, which captures Azania, is already live — no deferral applies to it.",
      },
      {
        id: "modC-17",
        title: "NZAOA — Frequently Asked Questions (target-setting rules)",
        depth: "READ",
        tag: "further",
        url: "https://www.unepfi.org/net-zero-alliance/about/frequently-asked-questions-net-zero-asset-owner-alliance/",
        blurb: "Signatories must publish targets 12 months after joining; infrastructure equity AND debt are mandatory target classes — WCKD's Nov 2026 deadline captures Azania.",
      },
      {
        id: "modC-4",
        ...
        blurb: "WCKD cannot afford Azania to be a carbon story it has to explain away two months before publishing its first targets. Its green demands are structural, not decorative. Note: a 5th edition shipped Mar 2026 (right next to this on the shelf) — check what changed before quoting mechanics.",
      },
      {
        id: "modC-24",
        title: "NZAOA Target-Setting Protocol, 5th edition released Mar 2026 (supersedes the 4th ed. above)",
        depth: "REF",
        tag: "recent",
        url: "https://www.unepfi.org/net-zero-alliance/",
        blurb: "Check what changed before quoting protocol mechanics at WCKD.",
      },
      {
        id: "modC-22",
        ...
        blurb: "WCKD's Azania equity is greenfield infrastructure whose decades of emissions enter its target maths at signing.",
      },
      {
        id: "modC-6",
      ...
      },
      {
        ...
        tag: "recent",
        url: "https://ieefa.org/resources/just-energy-transition-partnership-jetp-can-succeed-without-united-states",
        blurb: "Grants are only ~2.6–4% of JETP commitments, rest loans. URK talking point: investment and offtake, not loans that mortgage fiscal space.",
      },
      {
        id: "modC-18",
        title: "Convergence — State of Climate Blended Finance 2025 (Nov 2025)",
        depth: "SKIM",
        tag: "further",
        url: "https://www.convergence.finance/resource/state-of-climate-blended-finance-2025/view",
        blurb: "$15.5bn/84 deals in 2024, concentration in lower-middle-income countries — vocabulary for creative structuring of URK's $150m ask.",
      },
      {
        id: "modC-9",
  ...
  },
  {
    ...
    readings: [
      ...
      {
        id: "modD-5",
        title: "World Bank — procurement rules now require 30% local labour cost in international civil works (Jul 2025, effective 1 Sep 2025)",
        depth: "READ",
        tag: "further",
        url: "https://www.worldbank.org/en/news/press-release/2025/07/18/world-bank-group-strengthens-procurement-requirements-to-support-job-creation-skills-development/",
        blurb: "The strongest live precedent legitimising proposal (c): even the World Bank now mandates local-labour floors.",
      },
      {
        id: "modD-6",
        title: "World Bank — “Local Labor: Supporting Job Creation Through Operations Procurement” factsheet",
        depth: "REF",
        tag: "further",
        url: "https://thedocs.worldbank.org/en/doc/12df134a23770c0a9dd5d76fc69e6b17-0290012025/original/17340-WB-Local-Labor-FS.pdf",
        blurb: "Mechanics of how a local-labour requirement is defined, measured, and verified — drafting detail for (c).",
      },
      {
        id: "modD-7",
        title: "CGD — “The Role of MDB Local Content Rules in Industrial Strategy” (Oct 2025)",
        depth: "SKIM",
        tag: "further",
        url: "https://www.cgdev.org/publication/role-mdb-local-content-rules-industrial-strategy",
        blurb: "Balanced economics of local-content preferences — pre-empts “distortionary” pushback.",
      },
      {
        id: "modD-8",
        title: "CGD — critique of the World Bank local-labour rule",
        depth: "SKIM",
        tag: "further",
        url: "https://www.cgdev.org/blog/world-banks-new-local-labor-procurement-rule-mostly-ineffective-marginally-harmful-and-utterly",
        blurb: "Read the best case AGAINST (c) so the team can answer it before WCKD makes it.",
      },
      {
        id: "modD-4",
      ...
      },
      {
        ...
        tag: "recent",
        url: "https://www.carbonbrief.org/cop30-key-outcomes-for-food-forests-land-and-nature-at-the-un-climate-talks-in-belem/",
        blurb: "Frame proposal (c)-plus-training as URK operationalising the just transition — language WCKD's investors can reuse.",
      },
    ],
  },
  {
    ...
    readings: [
      ...
      {
        id: "modE-3",
        title: "CSIS — “Sovereign Cloud–Sovereign AI Conundrum” (Dec 2025)",
        depth: "SKIM",
        tag: "further",
        url: "https://www.csis.org/analysis/sovereign-cloud-sovereign-ai-conundrum-policy-actions-achieve-prosperity-and-security",
        blurb: "The policy debate around government cloud requirements — arms proposal (d) with vocabulary and anticipates SS's cost objections.",
      },
      {
        id: "modE-4",
        title: "BCG — “Sovereign Clouds Are Reshaping National Data Security” (Jun 2025)",
        depth: "REF",
        tag: "further",
        url: "https://www.bcg.com/publications/2025/sovereign-clouds-reshaping-national-data-security",
        blurb: "Government–hyperscaler partnership models: alternatives to the flat 5%-reservation if SS resists.",
      },
      {
        id: "modE-5",
        ...
        tag: "recent",
        url: "https://www.mddi.gov.sg/newsroom/public-consultation-on-digital-infrastructure-bill/",
        blurb: "Statutory resilience/continuity obligations reaching cloud providers, not just landlords. URK can propose a lighter contractual version — a classic “deal now or statute later” frame.",
      },
    ],
  },
  {
    ...
    readings: [
      ...
      {
        id: "modF-5",
        title: "Lawfare — “AI Data Centers Threaten Global Water Security”",
        depth: "SKIM",
        tag: "further",
        url: "https://www.lawfaremedia.org/article/ai-data-centers-threaten-global-water-security",
        blurb: "Water-transparency reporting as a low-cost, high-credibility ask (a 1 MW DC can use ~26m litres/yr).",
      },
      {
        id: "modF-4",
        title: "UNEP — Sustainable Procurement Guidelines for Data Centres and Servers (Jun 2025)",
        depth: "READ",
        tag: "further",
        url: "https://www.unep.org/technical-highlight/unep-releases-guidelines-curb-environmental-impact-data-centres",
        blurb: "UN-badged PUE/WUE/renewables indicators written FOR developing-country governments — the Environment Minister's cleanest citable framework.",
      },
      {
        id: "modF-6",
        title: "Ceres — “Drained by Data” (Sep 2025)",
        depth: "REF",
        tag: "further",
        url: "https://www.ceres.org/resources/reports/drained-by-data-the-cumulative-impact-of-data-centers-on-regional-water-stress",
        blurb: "Cumulative + indirect (power-generation) water stress framing — supports pairing (a) with water conditions.",
      },
      {
        id: "modF-8",
        ...
        blurb: "The Feb 2026 Gelang Patah protests, framed as “environmental externalisation” — arms URK to require water-impact assessment as a permit condition with live regional precedent.",
      },
      {
        id: "modF-9",
        ...
        blurb: "Concrete Options Bank entry: fold a water-reclamation facility into the Azania package.",
      },
      {
        id: "modF-7",
        title: "AGU Advances — “Data Centers Water Footprint: The Need for More Transparency” (Feb 2026)",
        depth: "REF",
        tag: "further",
        url: "https://agupubs.onlinelibrary.wiley.com/doi/10.1029/2025AV002140",
        blurb: "Peer-reviewed backing for facility-level water disclosure clauses (and against NDA-shrouded incentive deals).",
      },
    ],
  },
];
...
export const RECENCY_CHECKLIST = [
  ...
  "NZAOA Target-Setting Protocol 5th edition — what changed from the 4th",
];
